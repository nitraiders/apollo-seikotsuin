// gen_index_utf8.js - Generate index.html with HPB reproduction style
const fs = require('fs');
const path = require('path');

const scriptDir = __dirname;

const logo_b64 = fs.readFileSync(path.join(scriptDir, 'logo_b64.txt'), 'utf8').trim();
const mv_b64 = fs.readFileSync(path.join(scriptDir, 'main_visual_b64.txt'), 'utf8').trim();
        ...
        <main>
            ...
            <section class="section-card">
                ...
                <table class="data-table">
                    ...
                    <tr>
                        <th>\u30a2\u30af\u30bb\u30b9</th>
                        <td>\u65b0\u7530\u99c5\u304b\u3089\u5f92\u6b69\uff11\uff12\u5206\u3001\u30d0\u30b9\u505c\u89d2\u5c4b\u6a4b\u30d0\u30b9\u505c\u76ee\u306e\u524d</td>
                    </tr>
                    <tr>
                        <th>\u55b6\u696d\u6642\u9593</th>
                        <td>\u5e73\u65e5 \uff19:\uff10\uff10\uff5e\uff12\uff10:\uff10\uff10\uff08\u6700\u7d42\u53d7\u4ed8 \uff11\uff19:\uff13\uff10\uff09</td>
                    </tr>
                    <tr>
                        <th>\u5b9a\u4f11\u65e5</th>
                        <td>\u571f\u66dc\u30fb\u65e5\u66dc\u30fb\u795d\u65e5</td>
...
console.log('index.html with HPB style generated successfully.');
