...
<body>
    ...
    <div class="main-wrap">
        <header class="salon-header">
            ...
            <!-- ヘッダーのボタンは視線を分散させないため削除 -->
        </header>

        <nav>
            <ul class="tabs-nav">
                <li class="active"><a href="index.html">ホーム</a></li>
                <li class=""><a href="menu.html">メニュー</a></li>
                <li class=""><a href="staff.html">スタッフ</a></li>
                <li class=""><a href="photo.html">フォト</a></li>
                <li class=""><a href="gallery.html">ギャラリー</a></li>
                <li class=""><a href="blog.html">ブログ</a></li>
                <li class=""><a href="review.html">口コミ</a></li>
...
echo "index.html repaired.<br>";

// Repair review.html as well
$review_html = <<<HTML
<!DOCTYPE html>
<html lang="ja">
<head>
    ...
    <div class="main-wrap">
        ...
        <nav>
            <ul class="tabs-nav">
                ...
                <li class=""><a href="gallery.html">ギャラリー</a></li>
                <li class=""><a href="blog.html">ブログ</a></li>
                <li class="active"><a href="review.html">口コミ</a></li>
                <li class=""><a href="access.html">アクセス</a></li>
            </ul>
        </nav>
...
file_put_contents('review.html', $review_html);
echo "review.html repaired.<br>";

// Repair theme.css with logo size limit
$theme_css = file_get_contents('theme.css');
// Force max-width to 220px (middle of 200-250)
$theme_css = preg_replace('/\.site-logo\s*\{[^}]*max-width:\s*[^;]+;/', '.site-logo { max-width: 220px;', $theme_css);
file_put_contents('theme.css', $theme_css);
echo "theme.css repaired (logo size limit).<br>";
